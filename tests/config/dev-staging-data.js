// Development and Staging environment test data configuration
// This file contains test data specifically for development and staging environments

export const getDevStagingData = () => ({
  // Login credentials for Development and Staging
  login: {
  ...
  organization: {
    name: 'Dev Staging Org',
    email: 'devstaging@test.com',
    serviceAddress: {
      search: 'turya',
  ...
  customer: {
    firstName: 'Dev Customer',
    lastName: 'Testing',
    organization: 'Dev Corporation',
    email: 'devcustomer@test.com',
    serviceAddress: {
      search: 'walmart',
...
// Export singleton instance for dev/staging
export const devStagingData = getDevStagingData();
