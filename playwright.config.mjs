...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'PO',
      grep: /(Edit PO Lifecycle Tests should allow Edit PO at Draft status with all editable fields|Edit PO Lifecycle Tests should allow Edit PO at Submitted status|Edit PO Lifecycle Tests should allow Edit PO at Approved status and verify email API triggered|Edit PO Lifecycle Tests should allow Edit PO at Sent to Vendor with Associations restricted and send email|Edit PO Lifecycle Tests should allow Edit PO at Sent to Vendor with Associations restricted|Edit PO Lifecycle Tests should allow Edit PO at Vendor Accepted with Associations restricted|Edit PO Lifecycle Tests should allow Edit PO at Vendor Rejected with Associations restricted|Edit PO Lifecycle Tests should NOT allow Edit PO at Partially Fulfilled, Fulfilled, Invoiced, and Paid statuses|Edit PO Lifecycle Tests should show only Delete \(no Edit, no Cancel\) for Closed PO|Edit PO Lifecycle Tests should show edit history and status changes in Activity tab|Edit PO Lifecycle Tests should allow job completion when associated PO is in Draft status)$/i,
      use: {
        ...devices['Desktop Chrome'],
      },
    },
